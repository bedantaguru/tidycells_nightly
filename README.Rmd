...
imps_this <- intersect(imps, usr_pkgs)
sugg_this <- intersect(sugg, usr_pkgs)

pkgs_this <- tidycells:::pkg_dep_list(imps_this)
pkgs_sugg_this <- tidycells:::pkg_dep_list(sugg_this)

dep_str <- paste0(length(imps),"/",(length(pkgs_this))," [",length(pkgs_sugg_this),"]")
